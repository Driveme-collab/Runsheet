...
export function Onboarding() {
  ...
  function skip() {
    complete({ driverName: name.trim() || "Driver" });
  }

  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-background/95 p-4 sm:items-center">
      <div className="w-full max-w-md rounded-xl bg-card p-6 shadow-[var(--shadow-border)] sm:p-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {step === 0 && "This is your space. Records stay on this device."}
